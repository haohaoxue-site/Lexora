...
export interface BuddySessionCapability {
...
export interface BuddySessionCapabilityContext {
...
export type BuddySessionCapabilityFactory = (
  context: BuddySessionCapabilityContext,
) => Promise<readonly BuddySessionCapability[]>
