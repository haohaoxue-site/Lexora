...
use super::super::super::{rows::map_chat_run_event, BuddyChatRunEvent};

pub(in crate::storage::run_events::queries) fn list_chat_session_run_events(
...
pub(in crate::storage::run_events::queries) fn list_chat_conversation_run_events(
    connection: &Connection,
