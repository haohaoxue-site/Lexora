...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_buddy_approvals,
            commands::list_buddy_runtime_model_options,
            commands::list_buddy_chat_conversation_events,
            commands::list_buddy_chat_run_events,
            commands::list_buddy_chat_session_events,
            commands::list_buddy_conversation_messages,
            commands::list_buddy_conversation_run_events,
            commands::list_buddy_conversations,
            commands::list_buddy_messages,
            commands::list_buddy_codex_prompt_context_options,
            commands::list_buddy_run_event_summaries,
            commands::list_buddy_run_events,
            commands::list_buddy_runs,
            commands::list_buddy_session_run_events,
            commands::list_buddy_sessions,
            commands::minimize_buddy_current_window,
            commands::read_buddy_clipboard_files,
            commands::read_buddy_clipboard_image,
            commands::read_buddy_setting_json,
            commands::select_buddy_chat_attachment_files,
            ...
            commands::start_buddy_agent_turn,
