...
export type DesktopContextUsageSegmentKind = 'mcp' | 'messages' | 'skills' | 'systemPrompt' | 'tools'
export type DesktopContextUsageStatus = 'pending' | 'ready'

export interface DesktopContextUsageSegment {
  kind: DesktopContextUsageSegmentKind
  tokens: number
}
...
export interface DesktopContextUsage {
  ...
  segments: ReadonlyArray<DesktopContextUsageSegment>
  status: DesktopContextUsageStatus
  totalTokens: number | null
}

interface CreateDesktopContextUsageInput {
...
const EMPTY_SEGMENTS: ReadonlyArray<DesktopContextUsageSegment> = [
...
export function createDesktopContextUsage(
  input: CreateDesktopContextUsageInput,
