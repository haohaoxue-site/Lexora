...
import { projectChatMessageSearchResults } from '@/chat/chatMessageSearch'
...
export function useDesktopConversationSearch(options: DesktopConversationSearchOptions) {
