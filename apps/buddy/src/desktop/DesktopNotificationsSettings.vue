...
<template>
  <section v-if="chat.config.value" class="desktop-notifications-settings">
    ...
    <div class="desktop-notifications-settings__group">
      <div class="desktop-settings-row">
        ...
        <div class="desktop-settings-row__control">
          <NSwitch
            :value="chat.config.value.desktop.notificationsEnabled"
      ...
      <div v-if="chat.config.value.desktop.notificationsEnabled" class="desktop-settings-row">
        <div>
        ...
        <div class="desktop-settings-row__control">
          <NSwitch
            :value="chat.config.value.desktop.notifyWhenFocused"
