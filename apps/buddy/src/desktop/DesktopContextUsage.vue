...
import type {
  DesktopContextUsage,
  DesktopContextUsageSegmentKind,
} from './desktopContextUsage'
...
const props = defineProps<{
  ...
  usage: DesktopContextUsage | null
}>()
...
const segmentLabels: Record<DesktopContextUsageSegmentKind, BuddyI18nKey> = {
