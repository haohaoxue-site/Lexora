...
<template>
  <section v-if="chat.config.value" class="desktop-pet-settings">
    ...
    <div class="desktop-pet-settings__group">
      <div class="desktop-settings-row">
        ...
        <div class="desktop-settings-row__control">
          <NSwitch
            :value="chat.config.value.pet.enabled"
      ...
      <div class="desktop-settings-row">
        ...
        <div class="desktop-settings-row__control">
          <NSwitch
            :value="chat.config.value.pet.alwaysOnTop"
      ...
      <div class="desktop-settings-row">
        ...
        <div class="desktop-settings-row__control">
          <NSwitch
            :value="chat.config.value.pet.rememberPosition"
