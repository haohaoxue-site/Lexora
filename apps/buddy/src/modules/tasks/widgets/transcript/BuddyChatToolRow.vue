...
import { translateSystemAction, translateSystemToolStatus } from '../../model/approvals/systemActionPresentation'
...
<template>
  <section class="buddy-chat-tool" :class="`is-${node.status}`">
    <button
      ...
      @click="toggle"
    >
      <DesktopIcon :component="leadingIcon" class="buddy-chat-tool__icon" />
