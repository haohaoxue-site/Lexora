...
import type { ChatAgentReasoningGroup } from '../../model/transcript/chatStreamingMessage'
...
<template>
  <section class="buddy-chat-reasoning-group">
    <button
      ...
      @click="isOpen = !isOpen"
    >
      <DesktopIcon :component="Lightbulb20Regular" class="buddy-chat-reasoning-group__icon" />
