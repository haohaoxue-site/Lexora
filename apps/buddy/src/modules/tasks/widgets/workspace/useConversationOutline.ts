...
import type { ChatTranscriptProjection } from '@/modules/tasks/model/transcript/chatTranscriptProjection'
import { computed, readonly, shallowRef, watch } from 'vue'
import { createChatOutlineProjector } from '@/modules/tasks/model/transcript/chatOutline'
