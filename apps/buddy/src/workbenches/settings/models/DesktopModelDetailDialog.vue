...
import DesktopManualModelInfoPanel from '@/workbenches/settings/models/DesktopManualModelInfoPanel.vue'
import DesktopModelParametersPanel from '@/workbenches/settings/models/DesktopModelParametersPanel.vue'
...
const model = computed(() => providerSettings.registeredModels.value.find(item => (
