...
import type { LocalCustomProviderModel, LocalRuntimeModelOption } from '@buddy-electron/shared/localChatApi'
...
async function save() {
  ...
  if (await providerSettings.upsertManualModel(props.model.providerId, input))
    editing.value = false
}
</script>
