export const DESKTOP_TASK_SIDEBAR_LIST_PADDING_TOP = 4
export const DESKTOP_TASK_SIDEBAR_ROW_HEIGHT = 36
export const DESKTOP_TASK_SIDEBAR_ROW_SIZE = 40
export const DESKTOP_TASK_SIDEBAR_SECTION_HEADER_SIZE = DESKTOP_TASK_SIDEBAR_ROW_HEIGHT
