...
import type { BuddyComposerResource, BuddyComposerSource, BuddySpaceFileSource } from '@buddy-shared/composerResource'
import type { Ref } from 'vue'
import { parseLocalChatPublicError } from '@buddy-electron/shared/localChatApi'
import { BUDDY_ATTACHMENT_COUNT_LIMIT, BUDDY_ATTACHMENT_TOTAL_BYTES_LIMIT } from '@buddy-shared/attachmentPolicy'
import { computed, shallowReactive } from 'vue'

export interface ComposerResourceView {
  accepted: boolean
  canRetry: boolean
  resource: BuddyComposerResource
}
...
export function useComposerResources(options: UseComposerResourcesOptions) {
