...
<template>
  <div v-loading="isLoading" class="settings-default-models-page">
    <div class="settings-default-models-page__groups">
      <section
        v-for="group in AI_MODEL_INTENT_GROUPS"
        :key="group.key"
        class="settings-default-models-page__group"
      >
        <div class="settings-default-models-page__group-header">
          <div class="settings-default-models-page__group-title-line">
            <h2 class="m-0 text-lg font-bold text-main">
              {{ group.label }}
            </h2>
            <span class="settings-default-models-page__group-hint">
              {{ group.description }}
            </span>
          </div>

          <div class="settings-default-models-page__default-row">
            <span class="settings-default-models-page__default-label">默认模型</span>
            <ModelCascader
          ...
          <p v-if="getPolicyInvalidReason(group)" class="settings-default-models-page__group-error">
            {{ getPolicyInvalidReason(group) }}
          </p>
        </div>

        <div class="settings-default-models-page__rows">
          <section
            v-for="item in getGroupChildren(group)"
            :key="item.key"
            class="settings-default-models-page__row"
          >
            <div class="settings-default-models-page__row-title-line">
              <h3 class="m-0 text-sm font-semibold text-main">
                {{ item.label }}
              </h3>
              <span class="settings-default-models-page__row-hint">
...
.settings-default-models-page {
  ...
  .settings-default-models-page__groups {
    display: grid;
  ...
  .settings-default-models-page__group-title-line {
    display: flex;
    align-items: center;
  ...
  .settings-default-models-page__group-hint {
    flex: none;
  ...
  .settings-default-models-page__default-row {
    display: grid;
  ...
  .settings-default-models-page__default-label {
    color: var(--brand-text-regular);
    font-size: 0.8125rem;
    font-weight: 650;
    line-height: 1.25rem;
  ...
  .settings-default-models-page__group-error {
  ...
  .settings-default-models-page__row-title-line {
    display: flex;
    align-items: center;
    justify-content: space-between;
    min-width: 0;
  ...
  .settings-default-models-page__row-hint {
    flex: none;
...
@media (max-width: 1099px) {
  .settings-default-models-page {
    ...
    .settings-default-models-page__summary,
    .settings-default-models-page__group-title-line,
    .settings-default-models-page__row-title-line {
