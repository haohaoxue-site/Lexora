...
<template>
  <nav
    ...
    :class="props.showTitle ? null : 'mt-[0.28rem] border-l border-l-[color-mix(in_srgb,var(--brand-border-base)_62%,transparent)] pl-[0.82rem]'"
    aria-label="页面导航"
  >
    ...
    <ul class="publication-page-outline__list m-0 grid list-none gap-[0.28rem] p-0">
