...
export const DEFAULT_RBAC_SEED = {
  permissions: [
    ...
    {
      code: PERMISSIONS.SYSTEM_ADMIN_NOTIFICATION_READ,
      description: '查看系统站内信',
    },
    {
      code: PERMISSIONS.SYSTEM_ADMIN_NOTIFICATION_UPDATE,
      description: '创建和发布系统站内信',
    },
    {
      code: PERMISSIONS.SYSTEM_ADMIN_NOTIFICATION_DELETE,
      description: '删除系统站内信',
    },
    {
