...
export const CHAT_RUN_STATUS_VALUES = [
  ...
  CHAT_RUN_STATUS.REQUIRES_ACTION,
...
export const CHAT_SESSION_EVENT_TYPE = {
  ...
  RUN_REQUIRES_ACTION: 'chat.run.requires_action',
...
export const CHAT_SESSION_EVENT_TYPE_VALUES = [
  ...
  CHAT_SESSION_EVENT_TYPE.RUN_REQUIRES_ACTION,
...
export const CHAT_MESSAGE_ATTACHMENT_TYPE_VALUES = [
  ...
  CHAT_MESSAGE_ATTACHMENT_TYPE.IMAGE,
  CHAT_MESSAGE_ATTACHMENT_TYPE.FILE,
] as const
