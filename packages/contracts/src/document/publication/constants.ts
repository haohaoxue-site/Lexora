...
export const DOCUMENT_PUBLICATION_NAV_ITEM_TYPE_VALUES = [
  DOCUMENT_PUBLICATION_NAV_ITEM_TYPE.GROUP,
...
export const DOCUMENT_PUBLICATION_NAV_ITEM_LABEL_MAX_LENGTH = 40
export const DOCUMENT_PUBLICATION_NAV_ITEM_ICON_MAX_LENGTH = 500
export const DOCUMENT_PUBLICATION_NAV_ITEM_MAX_COUNT = 24
export const DOCUMENT_PUBLICATION_NAV_ITEM_MAX_DEPTH = 2
export const DOCUMENT_PUBLICATION_SITE_HOME_ACTION_MAX_COUNT = 3
export const DOCUMENT_PUBLICATION_SITE_HOME_FEATURE_MAX_COUNT = 8
export const DOCUMENT_PUBLICATION_SITE_HOME_ACTION_LABEL_MAX_LENGTH = 40
export const DOCUMENT_PUBLICATION_SITE_HOME_ACTION_HREF_MAX_LENGTH = 240
export const DOCUMENT_PUBLICATION_SITE_HOME_FEATURE_TITLE_MAX_LENGTH = 80
export const DOCUMENT_PUBLICATION_SITE_HOME_FEATURE_DETAILS_MAX_LENGTH = 240
export const DOCUMENT_PUBLICATION_SITE_HOME_FEATURE_ICON_MAX_LENGTH = 500
...
export const DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_SCOPE = {
  NAV_ICON: 'nav-icon',
  HOME_FEATURE_ICON: 'home-feature-icon',
} as const

export const DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_SCOPE_VALUES = [
...
export const DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_MAX_BYTES = 256 * 1024
export const DOCUMENT_PUBLICATION_SITE_HOME_FEATURE_ICON_MEDIA_MAX_BYTES = 256 * 1024
...
export const DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_MAX_BYTES_BY_SCOPE = {
  [DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_SCOPE.NAV_ICON]: DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_MAX_BYTES,
  [DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_SCOPE.HOME_FEATURE_ICON]: DOCUMENT_PUBLICATION_SITE_HOME_FEATURE_ICON_MEDIA_MAX_BYTES,
} as const satisfies Record<(typeof DOCUMENT_PUBLICATION_SITE_CUSTOM_MEDIA_SCOPE_VALUES)[number], number>
